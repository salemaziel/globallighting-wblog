                    ...
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isOpen} navbar style={{ textAlign: 'center' }}>
                         ...
                         <div className="donate-btn custom-dbox-popup">
                            <a href="https://donorbox.org/fighting-covid-19-with-ultraviolet-led-light" id="donate-btn">Donate</a> 
                        </div> 
                    </div>
                    </Navbar>
                       ...
                       <Link className="list" to="/campaigns">
                        ...
                        <div style={{padding: 20}}>
                            <div className="donate-btn-container" style={{paddingTop: 10, paddingBottom: 10}}>
                                <a href="https://donorbox.org/fighting-covid-19-with-ultraviolet-led-light" id="donate-btn-hamburger" >Donate</a>
                            </div>
                        </div>
